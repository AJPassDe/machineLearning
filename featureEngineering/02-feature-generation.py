# -*- coding: utf-8 -*-
"""
Created on Sun Jul  5 16:03:13 2020
...
# For example, if one record has the country "CA" and category "Music", you can create a new value "CA_Music"
...
train, valid, test = get_data_splits(clicks)
model2 = train_model(train, valid)
